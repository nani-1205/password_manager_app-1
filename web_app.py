...
def admin_users():
    ...
    # Use V3 logged in base but specific V4 admin content template
    return render_template('quantum_admin_users.html', users=all_users, current_username=session.get('username'))
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=5000, debug=True) # Keep debug=True for dev